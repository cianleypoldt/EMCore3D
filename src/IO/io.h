 ...
 */
template <typename T> using aligned_ptr = std::unique_ptr<T[], aligned_deleter>;
 ...
 */
template <typename T> aligned_ptr<T> make_aligned(size_t count, size_t align = alignof(T)) {
